...
public class NewStrategy implements MinePlayerStrategy {
...
//    public TurnAction moveToOtherQuadrant() {
//        if (isRedPlayer) {
//            int q3 = numberOfTilesInQuadrant(3);
//            int q1 = numberOfTilesInQuadrant(1);
//            if (q3 > q1) {
//
//            }
//        }
//    }
    ...
    public boolean enoughResourcesInQuadrant() {
        int quadrant;
        ...
        if (numberOfTilesInQuadrant(quadrant) < (double) (boardSize * boardSize / 4) * 0.08
                || numberOfTilesInQuadrant(quadrant) < 5) {
            return false;
        }
        return true;
    }
